...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setting = __webpack_require__(29);
	...
	var AxiosCache = function () {
	    function AxiosCache() {
	        ...
	        // 请求配置
	        this.__config = {};
	        this.__httpStatus = _setting2.default.httpStatus;
	        this.__clientCode = _setting2.default.clientCode;
	        this.init();
	    }
	    ...
	    _createClass(AxiosCache, [{
	        key: 'init',
	        value: function init() {
	            this.doFlushSetting(CACHE_KEY, _config2.default);
	            this.globalConfig = this.__config[CACHE_KEY] || {};
	        }
	        ...
	        key: 'doMapStatusCode',
	        value: function doMapStatusCode(http, client) {
	            this.__httpStatus = _extends(this.__httpStatus, http);
	            this.__clientCode = _extends(this.__clientCode, client);
	        }
	        ...
	        key: 'getMapStatusCodeKey',
	        value: function getMapStatusCodeKey(status) {
	            for (var code in this.__httpStatus) {
	        ...
	        key: 'doFlushSetting',
	        value: function doFlushSetting(key, conf) {
	            if (!key && typeof key !== 'string') {
	                return;
	            }
	            conf = _extends(this.__config[key] || {}, conf);
	        ...
	        key: 'handleErrorCase',
	        value: function handleErrorCase(code, result) {}
	        ...
	        key: 'sendRequest',
	        value: function sendRequest(key, options) {
	            var conf = _lodash2.default.cloneDeep((this.__config[this.settingKey] || {})[key]);
	            if (!conf) {
	            ...
	            if (this.globalConfig.mockBaseURL) {
	                ...
	                conf.headers = _extends(conf.headers || {}, {
	        ...
	        key: 'cbRequest',
	        value: function cbRequest(result, conf) {
	            ...
	            var codeKey = this.getMapStatusCodeKey(conf.resetReturnCode === undefined ? result.code : conf.resetReturnCode);
...
/***/ function(module, exports) {
	...
	exports.default = {
	   ...
	   * @return   {void}
	   */
	  post: function post(result, conf) {},
	  /**
	   * 格式化返回数据，符合view层展示需求
	   *
	   * @param    {Object}           result                   服务起返回原始数据
	   ...
	   * @return   {void}
	   */
	  format: function format(result, conf) {}
	};
