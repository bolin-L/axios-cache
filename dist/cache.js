...
/***/ function(module, exports, __webpack_require__) {
	...
	var AxiosCache = function () {
	    function AxiosCache() {
	        (0, _classCallCheck3.default)(this, AxiosCache);
	    ...
	    (0, _createClass3.default)(AxiosCache, [{
	        key: 'init',
	        value: function init() {
	        ...
	        value: function doMapStatusCode(http, client) {
	            this.__httpStatus = (0, _extends3.default)(this.__httpStatus, http);
	            this.__clientCode = (0, _extends3.default)(this.__clientCode, client);
	        }
	        ...
	        value: function getMapStatusCodeKey(status) {
	            ...
	            try {
	                for (var _iterator = (0, _getIterator3.default)(this.__httpStatus), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        value: function sendRequest(key, options) {
	            var conf = (this.__config[this.settingKey] || {})[key];
	            if (!key && typeof key !== 'string' || !conf) {
	                return;
	            }
	            conf = (0, _extends3.default)(conf, options);
	            (0, _axios2.default)(conf).then(function (response) {
	                var codeKey = this.getMapStatusCodeKey(response.status);
